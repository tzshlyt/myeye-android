...
package com.example.myeye.model
 ...
 * 首页-推荐列表，响应实体类。
 */
data class HomePageRecommend(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) {
